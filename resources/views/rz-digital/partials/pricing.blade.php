<section id="paket-harga" class="relative py-20 sm:py-28 bg-white dark:bg-zinc-950 text-[#2E2E2A] dark:text-zinc-100 overflow-hidden transition-colors duration-300">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="rz-reveal-up text-center max-w-3xl mx-auto mb-12 sm:mb-16">
            ...
            <p class="text-xs sm:text-sm text-[#595952] dark:text-zinc-400 mt-2 max-w-xl mx-auto leading-relaxed">
                Website berkualitas dan sistem toko handal dengan biaya transparan, terjangkau, dan langsung siap mendongkrak penjualan bisnis Anda.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch pt-4">
            ...
            <div class="rz-reveal-left rz-delay-1 rz-card-3d bg-white dark:bg-zinc-900 rounded-3xl p-6 sm:p-8 border border-zinc-200 dark:border-zinc-800 shadow-sm transition-all duration-300 flex flex-col justify-between">
                <div>
                    ...
                    <p class="text-xs text-[#595952] dark:text-zinc-400 mb-5">
                        Solusi 1 halaman fokus untuk promosi cepat produk/jasa atau kampanye iklan.
                    </p>

                    <!-- Price (Super Prominent) -->
                    <div class="mb-5 pb-5 border-b border-zinc-200 dark:border-zinc-800">
            ...
            <div class="rz-reveal-scale rz-delay-2 rz-card-3d bg-[#2E2E2A] dark:bg-zinc-900 text-[#F9F8F3] dark:text-zinc-100 rounded-3xl p-6 sm:p-8 border-2 border-[#8B9B70] shadow-2xl transition-all duration-300 flex flex-col justify-between relative lg:-translate-y-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-[#F9F8F3]/80 dark:text-zinc-400 mb-5">
                        Paket lengkap untuk membangun profil bisnis profesional, resmi, dan kredibel di Google.
                    </p>
            ...
            <div class="rz-reveal-right rz-delay-3 rz-card-3d bg-white dark:bg-zinc-900 rounded-3xl p-6 sm:p-8 border border-zinc-200 dark:border-zinc-800 shadow-sm transition-all duration-300 flex flex-col justify-between">
                <div>
                    ...
                    <p class="text-xs text-[#595952] dark:text-zinc-400 mb-5">
                        Website jualan online 24 jam + sistem kasir web untuk transaksi toko & cetak struk.
                    </p>
        ...
        <div class="rz-reveal-up rz-delay-2 mt-14 pt-10 border-t border-zinc-200 dark:border-zinc-800 max-w-5xl mx-auto">
            <div class="text-center mb-6">
                ...
                <p class="text-xs sm:text-sm text-[#595952] dark:text-zinc-400 mt-1">
                    Sesuaikan website dengan fitur ekstra sesuai perkembangan bisnis Anda.
                </p>
            </div>

            <!-- Add-ons Chips / Cards Grid -->
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-8">
                ...
                <div class="p-3.5 sm:p-4 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-2xs hover:border-[#8B9B70]/40 transition-colors flex items-center gap-2.5 sm:gap-3">
                    ...
                    <div class="text-[11px] sm:text-xs text-[#2E2E2A] dark:text-zinc-200 font-semibold leading-snug">
                        Integrasi Pembayaran <span class="block text-[9px] sm:text-[10px] text-[#595952] dark:text-zinc-400 font-normal">(QRIS / Bank)</span>
                    </div>
                </div>
                ...
                <div class="p-3.5 sm:p-4 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-2xs hover:border-[#8B9B70]/40 transition-colors flex items-center gap-2.5 sm:gap-3">
                    ...
                    <div class="text-[11px] sm:text-xs text-[#2E2E2A] dark:text-zinc-200 font-semibold leading-snug">
                        Halaman Tambahan <span class="block text-[9px] sm:text-[10px] text-[#595952] dark:text-zinc-400 font-normal">(Sesuai kebutuhan)</span>
                    </div>
                </div>
                ...
                <div class="p-3.5 sm:p-4 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-2xs hover:border-[#8B9B70]/40 transition-colors flex items-center gap-2.5 sm:gap-3">
                    ...
                    <div class="text-[11px] sm:text-xs text-[#2E2E2A] dark:text-zinc-200 font-semibold leading-snug">
                        Revisi Tambahan <span class="block text-[9px] sm:text-[10px] text-[#595952] dark:text-zinc-400 font-normal">(Luar kuota paket)</span>
                    </div>
                </div>
